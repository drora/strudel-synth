...
1. **Jam** — cold load / reload keeps the last kit when possible and reshuffles unlocked riffs (`kit · reshuffled`); bfcache restore re-runs fresh start; open the kit browser (search / soft tags), Play, Shuffle / Spice / deals.
