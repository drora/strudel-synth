    ...
    tracks: [
      {
        ...
        code: 's("bd*4").bank("RolandTR909").gain(1.2)',
      },
      {
        name: 'Hi-Hats',
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("~ hh ~ hh").bank("RolandTR909").gain(0.6)',
      },
      {
        name: 'Clap',
        role: 'fx',
        color: ROLE_COLORS.fx,
        code: 's("~ cp ~ cp").bank("RolandTR909").gain(0.8)',
      },
      {
        name: 'Bass',
        role: 'bass',
    ...
    tracks: [
      {
        ...
        role: 'drums',
        color: ROLE_COLORS.drums,
        code: 's("bd ~ ~ bd ~ ~ bd ~").bank("RolandTR808").gain(0.9)',
      },
      {
        name: 'Rim',
        role: 'fx',
        color: ROLE_COLORS.fx,
        code: 's("~ rim ~ ~ rim ~ ~ rim").bank("RolandTR808").gain(0.5)',
      },
      {
        name: 'Hi-Hats',
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("hh*8")\n  .bank("RolandTR909").gain("0.4 0.2 0.5 0.2 0.4 0.2 0.5 0.3")\n  .lpf(4000)',
      },
      {
        name: 'Chords',
        role: 'pad',
    ...
    tracks: [
      {
        ...
        role: 'drums',
        color: ROLE_COLORS.drums,
        code: 's("bd ~ ~ ~ bd ~ ~ ~").bank("RolandTR909").gain(1)',
      },
      {
        name: 'Rim',
        role: 'fx',
        color: ROLE_COLORS.fx,
        code: 's("~ ~ rim ~ ~ ~ rim ~").bank("RolandTR909").gain(0.6)',
      },
      {
        name: 'Shaker',
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("[~ hh]*4").bank("RolandTR909").gain(0.3).lpf(6000)',
      },
      {
        name: 'Bass',
        role: 'bass',
    ...
    tracks: [
      {
        ...
        role: 'drums',
        color: ROLE_COLORS.drums,
        code: 's("bd ~ ~ bd ~ ~ bd ~").bank("RolandTR909").gain(1.3)',
      },
      {
        name: 'Snare',
        role: 'fx',
        color: ROLE_COLORS.fx,
        code: 's("~ sd ~ ~ ~ sd ~ ~").bank("RolandTR909").gain(0.9)',
      },
      {
        name: 'Hi-Hats',
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("hh*8")\n  .bank("RolandTR909").gain("0.6 0.3 0.7 0.3 0.5 0.3 0.8 0.4")\n  .lpf(5000)',
      },
      {
        name: '808 Bass',
        role: 'bass',
    ...
    tracks: [
      {
        ...
        role: 'drums',
        color: ROLE_COLORS.drums,
        code: 's("bd [~ sd] bd [sd ~]").bank("RolandTR909").gain(1.1)',
      },
      {
        name: 'Hi-Hats',
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("hh*16")\n  .bank("RolandTR909").gain("0.5 0.2 0.4 0.2 0.6 0.2 0.3 0.2 0.5 0.2 0.4 0.2 0.7 0.2 0.3 0.2")\n  .lpf(8000)',
      },
      {
        name: 'Bass',
        role: 'bass',
    ...
    tracks: [
      {
        ...
        role: 'drums',
        color: ROLE_COLORS.drums,
        code: 's("bd*4").bank("RolandTR909").gain(1.1)',
      },
      {
        name: 'Hats',
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("~ hh ~ hh")\n  .bank("RolandTR909").gain(0.5)\n  .lpf(7000)',
      },
      {
        name: 'Clap',
        role: 'fx',
    ...
    tracks: [
      {
        ...
        role: 'drums',
        color: ROLE_COLORS.drums,
        code: 's("bd*4").bank("RolandTR909").gain(1)',
      },
      {
        name: 'Snare',
        role: 'fx',
      ...
      },
      {
        ...
        role: 'hihats',
        color: ROLE_COLORS.hihats,
        code: 's("hh*8")\n  .bank("RolandTR909").gain("0.5 0.3 0.6 0.3")\n  .lpf(6000)',
      },
      {
        name: 'Bass',
        role: 'bass',
