...
export const KITS: Kit[] = [
  ...
  },
  {
    ...
    bpm: 120,
    drumsBank: 'RolandCR78',
    tracks: [
      { name: 'Kick', role: 'drums', code: 's("bd ~ bd ~").bank("RolandCR78").gain(1.0)' },
      { name: 'Hi-Hats', role: 'hihats', code: 's("[hh oh] hh hh").bank("RolandCR78").gain(0.4)' },
      { name: 'Perc', role: 'fx', code: 's("~ cb ~ perc").bank("RolandCR78").room(0.35).gain(0.5)' },
  ...
  },
  {
    ...
    drumsBank: 'RolandCR78',
    tracks: [
      { name: 'Kick', role: 'drums', code: 's("bd ~ bd ~").bank("RolandCR78").gain(0.9)' },
      { name: 'Hats', role: 'hihats', code: 's("~ hh ~ hh").bank("RolandCR78").gain(0.35).lpf(3500)' },
      { name: 'Perc', role: 'fx', code: 's("~ ~ cp ~").bank("RolandCR78").room(0.4).gain(0.5)' },
  ...
  // —— Ambient ——
  {
    ...
    drumsBank: 'RolandCR78',
    tracks: [
      { name: 'Pulse', role: 'drums', code: 's("bd ~ ~ ~").bank("RolandCR78").gain(0.45).lpf(800)' },
      { name: 'Shimmer', role: 'hihats', code: 's("~ hh ~ ~").bank("RolandCR78").gain(0.15).room(0.8)' },
  ...
  },
  {
    ...
    drumsBank: 'RolandCR78',
    tracks: [
      { name: 'Kick', role: 'drums', code: 's("bd*4").bank("RolandCR78").gain(1.05)' },
      { name: 'Hats', role: 'hihats', code: 's("hh hh oh hh").bank("RolandCR78").gain(0.42)' },
      { name: 'Clap', role: 'fx', code: 's("~ cp ~ cp").bank("RolandCR78").gain(0.7)' },
